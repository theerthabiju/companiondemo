        ...
        <div className="row gy-4 footerrow">
          ...
          <div className="col-6 col-md-6 col-lg-3 text-lg-start footercol2">
            ...
            <div className="links">
              <p>
                {" "}
                <Link to="/companion/aboutus">About Us</Link>
              </p>
              <p>
                {" "}
                <Link to="/companion/Contact">Contact Us</Link>
              </p>
              <p>
                <Link to="/companion/community">Community List</Link>
              </p>
              <p>
                <Link to="/companion/postnewride">Post a New Ride</Link>
              </p>
            </div>
          </div>
          ...
          <div className="col-6 col-md-6 col-lg-2  text-lg-start footercol3">
            ...
            <div className="links2">
              <p>
                <i className="bi bi-telephone-fill me-1"></i> +91 70000 12222
              </p>
              <p>
                <i className="bi bi-geo-alt-fill me-1"></i> Kerala, India
              </p>
              <p>
                <i className="bi bi-envelope-fill me-1"></i> companion@gmail.com
              </p>
            </div>
          </div>
