...
const Login= () => {
  ...
  />
          ...
          <div className="col-md-6 d-flex logincol2 align-items-center">
            <div className="login-content w-100 px-4  ">
              <h5 className="text-center mb-4 loginhead">
              Login 
              </h5>
 ...
 <button className=" text-primary createaccountbutton mt-2"
     ...
     Create New account </button>
              ...
              <div className="row orregisterhead mt-2">
                ...
                <div className="col-md-4 text-center">
                  <span className="orregistertext text-center">Or Register With</span>
                </div>
                <div className="col-md-4">
                  <span className="loginline">
                    {" "}
